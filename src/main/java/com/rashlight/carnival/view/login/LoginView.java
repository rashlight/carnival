package com.rashlight.carnival.view.login;

import com.rashlight.carnival.entity.User;
import com.rashlight.carnival.view.dashboard.DashboardView;
import com.rashlight.carnival.view.guessnum.GuessNumView;
...
public class LoginView extends StandardView implements LocaleChangeObserver {
    ...
    protected void initDefaultCredentials() {
        if (!Objects.isNull(defaultUsername)) {
            login.setUsername(defaultUsername);
        }

        if (!Objects.isNull(defaultPassword)) {
    ...
    public void onLogin(final LoginEvent event) {
        try {
            ...
            viewNavigators.view(DashboardView.class).navigate();
